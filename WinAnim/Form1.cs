...
namespace WinAnim
{
    public partial class Form1 : Form
    {
        ...
        public class WinAPIClass
        {
            ...
            /// <summary>
            /// Тип анимации окна. Перечисление возвращает тип int после приведения. Каждому элементу присвоено своё значение типа int. 
            /// </summary>
            [Flags]
            ...
            /// <param name="dwFlags">Тип анимации. Если в неуправляемом коде используется  перечисление, то его нужно конвертировать в тип данных int. </param>
            /// <returns></returns>
